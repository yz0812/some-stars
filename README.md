...
*   [AIAllABOUTYOU/AySub](https://github.com/AIAllABOUTYOU/AySub) -

*   [caidaoli/CLIProxyAPI](https://github.com/caidaoli/CLIProxyAPI) - Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service, allowing you to enjoy the free Gemini 2.5 Pro, GPT 5, Claude, Qwen model through API
...
*   [seakee/CPA-Manager](https://github.com/seakee/CPA-Manager) - This is a WebUI interface based on CLI-Proxy-API, designed to simplify configuration modifications and runtime status monitoring.

*   [QingJ01/DeepSeekCode](https://github.com/QingJ01/DeepSeekCode) - 基于 Claude Code 代码库改造的本地 CLI 编程代理
...
*   [dark-hxx/CLI-Manager](https://github.com/dark-hxx/CLI-Manager) - CLI-Manager: 用于集中管理基于CLI 的多个开发项目，解决多窗口切换、重复输入命令的痛点，提升开发工作流效率。
...
*   [uncarbon97/helio-boot-modular](https://github.com/uncarbon97/helio-boot-modular) - 基于 Spring Boot 3.x，是一款预置SaaS、RBAC能力的单体项目脚手架，适合初学者学习 JavaWeb 开发的良好实践；本项目已拆分多Maven模块，单模块版请移步至helio-boot项目
...
*   [MeowLynxSea/easy\_todo](https://github.com/MeowLynxSea/easy_todo) - A simple and elegant todo list app with support for Pomodoro timer, recurring tasks, data statistics functions, plus with LLM integration.
...
*   [shanselman/toasty](https://github.com/shanselman/toasty) - Tiny Windows toast notification CLI (229 KB)
